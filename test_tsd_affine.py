...
fixedMesh = itk.meshread('/home/pranjal.sahu/SlicerMorph/A_J_skull_temp5.vtk', itk.D)
movingMesh = itk.meshread('/home/pranjal.sahu/SlicerMorph/NOD_SHILTJ_temp5.vtk', itk.D)
...
itk.meshwrite(movingMesh, 'result.vtk')
