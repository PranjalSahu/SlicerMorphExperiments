...
def process(
    ...
    movingMesh_Rigid = itk.transform_mesh_filter(
        movingMesh_RANSAC, transform=second_transform
    )
    write_itk_mesh(
        movingMesh_Rigid, WRITE_PATH + casename + "_movingMeshRigidRegistered.vtk"
    )
